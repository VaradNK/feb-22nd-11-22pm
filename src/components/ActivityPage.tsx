  ...
  return (
    <>
      ...
      >
          ...
          <div className="w-full max-w-4xl bg-pink-50/95 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-retro border-2 border-primary/30">
          ...
          {!showLetter ? (
            ...
            >
              ...
              >
                ...
                <div className="relative w-80 h-56 mx-auto transition-all duration-500 hover:scale-105">
                  {/* Envelope Body */}
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-200 to-pink-300 rounded-lg shadow-lg border-2 border-primary/30" />
                  
                  {/* Envelope Flap */}
                  <div 
                    className={`absolute -top-1 left-0 right-0 h-28 bg-gradient-to-br from-pink-300 to-pink-400 transition-all duration-1000 ease-out origin-top ${
                  ...
                  {/* Letter peeking out */}
                  {isEnvelopeOpen && (
                    <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-72 h-48 bg-gradient-to-b from-white to-pink-100/40 rounded shadow-xl animate-letter-emerge border border-primary/20" />
                  )}
                ...
                {!isEnvelopeOpen && (
                  <div className="text-center mt-6 animate-fade-in">
                    ...
                    <div className="inline-block px-4 py-2 bg-pink-200/80 rounded-full text-xs font-bold text-primary border-2 border-primary/30 animate-pulse shadow-sm">
            ...
            >
              <div className="bg-gradient-to-br from-white to-pink-50/30 rounded-xl p-6 md:p-8 lg:p-10 shadow-inner border-2 border-primary/20 min-h-[350px] md:min-h-[400px] relative max-w-5xl mx-auto flex flex-col justify-between">
